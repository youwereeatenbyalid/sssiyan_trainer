...
struct REMethodDefinition : public sdk::REMethodDefinition_ {
    ...
    struct CallHelperRet {
        ...
        struct Dispatcher {
            template<typename T>
            Dispatcher(const REMethodDefinition* t, T&& args) 
            : target{t}, 
            args(args)
            {
        ...
        struct Packer {
            ...
            static auto pack(const sdk::REMethodDefinition* target, T&& args, std::index_sequence<I...>) {
                return Dispatcher<I...>{target, args};
            }

            template<typename T>
            static auto pack(const sdk::REMethodDefinition* target, T&& args) {
