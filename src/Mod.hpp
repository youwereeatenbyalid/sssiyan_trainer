...
public:
    enum page_enum {breaker,wiresnatch,nero,dantesdt,dantecheat,commoncheat,vergilsdt,vergiltrick,vergildoppel,vergilcheat,vergilefxsettings,gamemode,bloodypalace,balance,camera,qol,mechanics,enemystep,animation,taunt, gilver, secretmission};
