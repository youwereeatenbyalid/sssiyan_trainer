...
public:
    enum page_enum {breaker,wiresnatch,nero,dantesdt,dantecheat,commoncheat,vergilsdt,vergiltrick,vergildoppel,vergilcheat,vergilafterimages,gamemode,bloodypalace,balance,camera,qol,mechanics,enemystep,animation,taunt, gilver};
