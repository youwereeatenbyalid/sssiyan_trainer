...
private:
	...
	std::shared_ptr<Detour_t> m_player_detour;
	std::shared_ptr<Detour_t> m_summon_detour;
	std::shared_ptr<Detour_t> m_incombat_detour;
	std::shared_ptr<Detour_t> m_sin_detour;
	std::shared_ptr<Detour_t> m_cos_detour;
	std::shared_ptr<Detour_t> m_threshhold_detour;
	std::shared_ptr<Detour_t> m_vergildata_detour;
	std::shared_ptr<Detour_t> m_pl_manager_add_pl_detour;
	std::shared_ptr<Detour_t> m_pad_input_reset_detour;
	std::shared_ptr<Detour_t> m_pl0800_on_guard_detour;
	std::shared_ptr<Detour_t> m_pl_set_die_detour;
	std::shared_ptr<Detour_t> m_pl_lock_on_update_detour;
	std::shared_ptr<Detour_t> m_pl0000_quicksilver_slow_world_action_start_detour;
	std::shared_ptr<Detour_t> m_pl0000_quicksilver_stop_world_action_start_detour;
	std::shared_ptr<Detour_t> m_set_trick_style_detour;
	std::shared_ptr<Detour_t> m_set_sword_style_detour;
	std::shared_ptr<Detour_t> m_set_gun_style_detour;
	std::shared_ptr<Detour_t> m_set_royal_style_detour;
	std::shared_ptr<Detour_t> m_pl_add_dt_gauge_detour;
	std::shared_ptr<Detour_t> m_pl_just_escape_detour;
	std::shared_ptr<Detour_t> m_fsm2_pl_pos_cntr_update_speed_detour;
	std::shared_ptr<Detour_t> m_fsm2_pl_pos_cntr_start_action_detour;
	std::shared_ptr<Detour_t> m_pl_remove_detour;
	std::shared_ptr<Detour_t> m_pl0800_set_air_trick_action_detour;
	std::shared_ptr<Detour_t> m_fsm2_player_player_action_notify_action_end_detour;
	std::shared_ptr<Detour_t> m_pl_nero_set_table_hopper_detour;
};