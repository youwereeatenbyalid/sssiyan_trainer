...
void PlCntr::Pl0300Cntr::Pl0300Controller::destroy_game_obj()
{
	if (get_pl() != 0 && !is_doppel())
	{
		...
		{
			sdk::call_object_func_easy<void*>(get_pl_manager(), "removePlayer(app.Player, System.Boolean)", (REManagedObject*)get_pl(), false);
		}
...
void PlCntr::Pl0300Cntr::Pl0300Controller::destroy_doppel()
{
	...
	if (_pl0300RequestDestroyDoppelMethod != nullptr)
		_pl0300RequestDestroyDoppelMethod->call(sdk::get_thread_context(), get_pl());
