...
public:
  StyleEditorWindow() { SetTitle("Style Editor"); }
  virtual void OnGui() {
    ImGuiStyle* ref = NULL;

    ImGuiStyle& style = ImGui::GetStyle();

    ImwWindowManager::Config& oConfig =
        ImwWindowManager::GetInstance()->GetConfig();

    ImGui::Checkbox("Visible dragger", &oConfig.m_bVisibleDragger);
    ImGui::Text("Tab color mode");
    ImGui::RadioButton("1. Button", (int*)&oConfig.m_eTabColorMode,
                       ImwWindowManager::E_TABCOLORMODE_TITLE);
    ImGui::RadioButton("2. Background", (int*)&oConfig.m_eTabColorMode,
                       ImwWindowManager::E_TABCOLORMODE_BACKGROUND);
    ImGui::RadioButton("3. Custom", (int*)&oConfig.m_eTabColorMode,
                       ImwWindowManager::E_TABCOLORMODE_CUSTOM);

    ImGui::Indent();
    ImGui::ColorEdit4("Active##Tab", (float*)&oConfig.m_oTabColorActive.Value.x,
                      true);
    ImGui::ColorEdit4("Normal##Tab", (float*)&oConfig.m_oTabColorNormal.Value.x,
                      true);
    ImGui::ColorEdit4("Border##Tab", (float*)&oConfig.m_oTabColorBorder.Value.x,
                      true);
    ImGui::Unindent();

    ImGui::PushItemWidth(100.f);
    ImGui::DragFloat("Drag margin ratio", &oConfig.m_fDragMarginRatio, 0.01f,
                     0.f, 1.f);
    ...
    ImGui::DragFloat2("StatusBarFramePadding",
                      (float*)&oConfig.m_oStatusBarFramePadding);
    ...
    if (ImGui::SmallButton("Blue##Color")) {
      ...
      style.Colors[ImGuiCol_FrameBgHovered] =
          ImVec4(0.16f, 0.50f, 0.73f, 0.78f);
      ...
      style.Colors[ImGuiCol_TitleBgCollapsed] =
          ImVec4(0.22f, 0.31f, 0.41f, 0.75f);
      ...
      style.Colors[ImGuiCol_ScrollbarGrabHovered] =
          ImVec4(0.16f, 0.50f, 0.73f, 0.78f);
      style.Colors[ImGuiCol_ScrollbarGrabActive] =
          ImVec4(0.16f, 0.50f, 0.73f, 1.00f);
      ...
      style.Colors[ImGuiCol_CloseButtonHovered] =
          ImVec4(0.93f, 0.94f, 0.95f, 0.39f);
      style.Colors[ImGuiCol_CloseButtonActive] =
          ImVec4(0.93f, 0.94f, 0.95f, 1.00f);
      ...
      style.Colors[ImGuiCol_PlotHistogramHovered] =
          ImVec4(0.16f, 0.50f, 0.73f, 1.00f);
      style.Colors[ImGuiCol_TextSelectedBg] =
          ImVec4(0.16f, 0.50f, 0.73f, 0.43f);
      style.Colors[ImGuiCol_ModalWindowDarkening] =
          ImVec4(0.22f, 0.31f, 0.41f, 0.73f);
    }
    ...
    if (ImGui::SmallButton("White##Color")) {
      ...
      style.Colors[ImGuiCol_FrameBgHovered] =
          ImVec4(0.95f, 0.33f, 0.14f, 0.47f);
      ...
      style.Colors[ImGuiCol_PlotHistogramHovered] =
          ImVec4(1.00f, 0.60f, 0.00f, 1.00f);
      style.Colors[ImGuiCol_TextSelectedBg] =
          ImVec4(1.00f, 0.99f, 0.54f, 0.43f);
      style.Colors[ImGuiCol_ModalWindowDarkening] =
          ImVec4(0.20f, 0.20f, 0.20f, 0.35f);
    }
    ...
    if (ImGui::TreeNode("Sizes")) {
      ImGui::SliderFloat(
          ...
          "%.2f"); // Not exposing zero here so user doesn't "lose" the UI. But
                   // application code could have a toggle to switch between
                   // zero and non-zero.
      ...
      ImGui::SliderFloat("IndentSpacing", &style.IndentSpacing, 0.0f, 30.0f,
                         "%.0f");
      ImGui::SliderFloat("ScrollbarWidth", &style.ScrollbarSize, 1.0f, 20.0f,
                         "%.0f");
    ...
    if (ImGui::TreeNode("Colors")) {
      ...
      if (ImGui::Button("Output Colors")) {
        if (output_dest == 0)
          ...
          ImGui::LogToTTY();
        ImGui::LogText("ImGuiStyle& style = ImGui::GetStyle();" ImNewline);
        for (int i = 0; i < ImGuiCol_COUNT; i++) {
          const ImVec4& col = style.Colors[i];
          const char* name  = ImGui::GetStyleColorName(i);
          if (!output_only_modified ||
              memcmp(&col, (ref ? &ref->Colors[i] : &def.Colors[i]),
                     sizeof(ImVec4)) != 0)
            ImGui::LogText("style.Colors[ImGuiCol_%s]%*s= ImVec4(%.2ff, %.2ff, "
                           "%.2ff, %.2ff);" ImNewline,
                           name, 22 - (int)strlen(name), "", col.x, col.y,
                           col.z, col.w);
        }
        ImGui::LogFinish();
      }
...
public:
  NodeWindow(void) { SetTitle("Node editor"); }
  ...
  virtual void OnGui() {
    ...
    if (!inited) {
      nodes.push_back(Node(0, "MainTex", ImVec2(40, 50), 0.5f,
                           ImColor(255, 100, 100), 1, 1));
      nodes.push_back(Node(1, "BumpMap", ImVec2(40, 150), 0.42f,
                           ImColor(200, 100, 200), 1, 1));
      nodes.push_back(Node(2, "Combine", ImVec2(270, 80), 1.0f,
                           ImColor(0, 200, 100), 2, 2));
    ...
    ImGui::PushStyleColor(
        ...
        ImVec4(60 / 255.f, 60 / 255.f, 70 / 255.f, 200 / 255.f));
    ...
    for (int node_idx = 0; node_idx < nodes.Size; node_idx++) {
      ...
      draw_list->AddRectFilled(node_rect_min, node_rect_max, node_bg_color,
                               3.0f);
      draw_list->AddRect(node_rect_min, node_rect_max, ImColor(100, 100, 100),
                         3.0f);
    ...
    if (ImGui::BeginPopup("context_menu")) {
      ...
      if (node) {
        ...
        if (ImGui::MenuItem("Add")) {
          nodes.push_back(Node(nodes.Size, "New node", scene_pos, 0.5f,
...
public:
  MyToolBar(ModFramework* mf) : ImwToolBar() { p_mf = mf; }
...
public:
  ...
  virtual void OnMenu() {
    if (ImGui::BeginMenu("My menu")) {
      if (ImGui::MenuItem("Show content", NULL,
                          ImWindow::ImwWindowManager::GetInstance()
                              ->GetMainPlatformWindow()
                              ->IsShowContent())) {
        ImWindow::ImwWindowManager::GetInstance()
            ->GetMainPlatformWindow()
            ->SetShowContent(!ImWindow::ImwWindowManager::GetInstance()
                                  ->GetMainPlatformWindow()
                                  ->IsShowContent());
      }
...
public:
  MyImwWindow3(const char* pTitle = "MyImwWindow3") { SetTitle(pTitle); }
  ...
  virtual void OnGui() {
    if (!IsClosable()) {
      ...
      ImGui::TextWrapped(
          "So you can't close the platform window\nuntil closing me.");
      ImGui::PopStyleColor();
    ...
    if (pManager->GetFocusedPlatformWindow() ==
        pManager->GetCurrentPlatformWindow())
...
public:
  MyImwWindow2(const char* pTitle = "MyImwWindow2") { SetTitle(pTitle); }
...
public:
  ...
  virtual void OnGui() {
    ...
    if (p_mf->is_error() && p_mf->is_ready()) {
      auto& focusmod =
          p_mf->get_mods()->get_mod(p_mf->get_mods()->get_focused_mod());
...
public:
  ...
  NeroWindow(ModFramework* mf) : super(mf, "Nero") {}
  virtual void OnGui() {
    // ImGui::PushStyleColor(ImGuiCol_Header,ImVec4(0.306f, 0.541f, 0.804f,
    // 0.600f)); ImGui::PushStyleColor(ImGuiCol_HeaderHovered,ImVec4(0.408f,
    // 0.643f, 0.906f, 1.000f)); ImGui::PushStyleColor(ImGuiCol_HeaderActive,
    // ImVec4(0.408f, 0.643f, 0.906f, 1.000f));
    super::OnGui();
    ImGui::Separator();
    ImGui::Text("Breaker");
    if (p_mf->is_error() && p_mf->is_ready()) {
...
public:
  typedef PageWindow super;
  DanteWindow(ModFramework* mf) : super(mf, "Dante") {}
  virtual void OnGui() {
    super::OnGui();
    ImGui::Separator();
    ImGui::Text("SDT");
...
public:
  typedef PageWindow super;
  GilverWindow(ModFramework* mf) : super(mf, "V") {}
  virtual void OnGui() {
    super::OnGui();
    ImGui::Separator();
    ImGui::Text("V cheats");
...
public:
  typedef PageWindow super;
  VergilWindow(ModFramework* mf) : super(mf, "Vergil") {}
  virtual void OnGui() {
    // ImGui::PushStyleColor(ImGuiCol_Header, ImVec4(0.306f, 0.804f, 0.804f,
    // 0.600f)); ImGui::PushStyleColor(ImGuiCol_HeaderHovered, ImVec4(0.408f,
    // 0.906f, 0.906f, 0.702f)); ImGui::PushStyleColor(ImGuiCol_HeaderActive,
    // ImVec4(0.408f, 0.906f, 0.906f, 0.702f));
    super::OnGui();
    ImGui::Separator();
    ImGui::Text("SDT");
    if (p_mf->is_error() && p_mf->is_ready()) {
...
public:
  typedef PageWindow super;
  ScenarioWindow(ModFramework* mf) : super(mf, "Scenario") {}
  virtual void OnGui() {
    super::OnGui();
    ImGui::Separator();
...
public:
  typedef PageWindow super;
  PracticeWindow(ModFramework* mf) : super(mf, "Practice") {}
  virtual void OnGui() {
    super::OnGui();
    ImGui::Separator();
...
public:
  typedef PageWindow super;
  SystemWindow(ModFramework* mf) : super(mf, "System") {}
  virtual void OnGui() {
    super::OnGui();
    ImGui::Separator();
    ImGui::Text("Camera");
...
public:
  typedef PageWindow super;
  GameplayWindow(ModFramework* mf) : super(mf, "Gameplay") {}
  virtual void OnGui() {
    super::OnGui();
    ImGui::Separator();
...
public:
  PlaceholderWindow() : ImwWindow(ImWindow::E_WINDOW_MODE_PLACEHOLDER) {}
