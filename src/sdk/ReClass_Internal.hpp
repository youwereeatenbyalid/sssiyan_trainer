...
static_assert(sizeof(REGameObject) == 0x60);
...
static_assert(sizeof(RETransform) == 0x1F8);
...
static_assert(sizeof(REObjectInfo) == 0x68);
...
static_assert(sizeof(REClassInfo) == 0x78);
...
static_assert(sizeof(RopewayPlayerCameraController) == 0x1D8);
...
static_assert(sizeof(REMotion) == 0x3A0);
...
static_assert(sizeof(RopewayCameraSystem) == 0x138);
...
static_assert(sizeof(RopewayMainCameraController) == 0xF0);
...
static_assert(sizeof(TypeListArray) == 0xB71B00);
...
static_assert(sizeof(REArrayThing) == 0x68);
...
static_assert(sizeof(RopewaySurvivorPlayerCondition) == 0x2A0);
...
static_assert(sizeof(HIDJoypadDevice) == 0x2B0);
