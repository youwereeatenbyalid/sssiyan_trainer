...
void bindings::open_imgui(LuaMod* m) {
    sol::state_view lua{ m->get_mod_state() };
    ...
    lua["imgui"] = imgui;
    //yeah lets actually add this stuff when we need it as opposed to introducing two new dependencies out of the blue.
