    ...
    if (HWND focused_hwnd = ::GetForegroundWindow())
    {
        ...
        if (io.ConfigFlags & ImGuiConfigFlags_ViewportsEnable)
        {
            ...
            if (ImGui::FindViewportByPlatformHandle((void*)focused_hwnd) != NULL)
                io.MousePos = ImVec2((float)mouse_screen_pos.x * io.DisplayFramebufferScale.x, (float)mouse_screen_pos.y * io.DisplayFramebufferScale.y);
        }
        else
        {
            ...
            if (focused_hwnd == g_hWnd)
            {
                ...
                io.MousePos = ImVec2((float)mouse_client_pos.x * io.DisplayFramebufferScale.x, (float)mouse_client_pos.y * io.DisplayFramebufferScale.y);
            }
        }
    }
